...
def train(nets: nn.ModuleDict, dataloader: torch.utils.data.DataLoader, device: torch.device, noise_scheduler: DDPMScheduler, dataset_stats: Dict[str, float], config: Dict[str, int], checkpoint_path: Optional[str] = None) -> nn.ModuleDict:
        ...
        for epoch_idx in tglobal:
            ...
            with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
                for nbatch in tepoch:
                    ...
                    assert image_features.shape == (B, config['obs_horizon'], 512)
            ...
            if epoch_idx % 10 == 0:  # Checkpoint every epoch; adjust as needed
...
def load_pretrained(nets: nn.ModuleDict, ckpt_path: str) -> nn.ModuleDict:
...
def main():
    ...
    dataset_path = "C:/Users/vrushank/Documents/Github/diffusion_multi/diffusion_multi_image_multi_gpu/data/output.zarr"
    ...
    ema_nets = train(nets, dataloader, device, noise_scheduler, dataset.stats, config, checkpoint_path)
